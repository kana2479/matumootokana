...
public class Qes1_13 {
	public static void main(String[] args) {
		...
		*/
		...
		// BMIを出す。ただし計算は数値を直書きせず、全て変数を使ってする
		// BMIの計算
		...
		System.out.print("身長は" + height + "cmです\n");
		System.out.print("体重は" + weight + "kgです\n");
		System.out.print("好きな食べ物は" + weight + "です\n");
		...
		System.out.print("はじめまして" + name + "です\n");
		System.out.print("年齢は" + age + "歳です\n");
		System.out.print("身長は" + height + "cmで\n");
		System.out.print("体重は" + weight + "kgです\n");
		System.out.print("好きな食べ物は" + weight + "です\n");
		System.out.print("BMIは" + bmi2 + "です\n");
		System.out.print("\n");
		...
		String ah = "";
		ah = age3 == 25 || height3 > 160 ? "true" : "false";
